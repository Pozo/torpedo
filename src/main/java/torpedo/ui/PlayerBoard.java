...
public class PlayerBoard extends JPanel implements GameBoardPrinter {
	...
	public PlayerBoard(GameBoard gameBoard) {
		...
		this.playerBoard = createPlayerBoard(gameBoard);
		this.actionList = createPlayerBoardActions();
	...
	public void drawHitAt(Coordinate coordinate) {
		...
		/*
		System.out.println((gameBoard.getHeight()-coordinate.getY()));
		...
		*/
		BoardCell cell2 = (BoardCell) playerBoard.getComponent((gameBoard.getHeight()-coord2.getY()-1)*((gameBoard.getHeight()-coord2.getX())*coord2.getY()+1));
